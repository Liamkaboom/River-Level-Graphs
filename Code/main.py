# CSV file last updated: 8th Feb 2026. Data goes back to late 2020.
import matplotlib.pyplot as plt
import pandas as pd

df = pd.read_csv("CSV/black-sluice-ps-boston-lincolnshire-080226.csv")  # Read Comma Separated Value (CSV) file for station data.
...
filteredDf = df[(df["date"] >= startDate) & (df["date"] <= endDate)] # Goes through every... single... row... in the csv file and filters the dates between the startDate and endDate variables.
